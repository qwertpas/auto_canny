...
if getTargetPosition(camera_capture)[3] == 2:
    print("ratio 0-1 : " + str(rectareas[0]/rectareas[1]))
...
'''
img = cv2.imread('/Users/yiyi/Desktop/inputLeft.jpg')

img = cv2.flip(img, 0)
print("targetpositions : " + str(getTargetPosition(img)))
